...
initMTL_path = '/global/cscratch1/sd/mjwilson/S4MOCK/orig_mtls/bright/sv3mtl-bright-hp-0.ecsv'
# initMTL = Table.read(initMTL_path)
# initMTL.pprint()

outputMTL_path = '/global/cscratch1/sd/mjwilson/S4MOCK/alt_mtls/{:d}/'
...
#
#  Note:  writes to e.g.  /global/cscratch1/sd/mjwilson/S4MOCK/alt_mtls/0/sv3/bright/sv3mtl-bright-hp-0.ecsv
#

# initializeAlternateMTLs(initMTL_path, outputMTL_path, nAlt = 2, seed = 314159, obscon = 'BRIGHT')

alt_mtldir = '/global/cscratch1/sd/mjwilson/S4MOCK/alt_mtls/'
